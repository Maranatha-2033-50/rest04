...
export const company = {
  ...
  slogan: { ko: '내 취약점을 알면, 합격이 보입니다', en: 'Know your weak points, see your success' },
  copyright: '© 2026 EDUFOCUS EDU Corp. All rights reserved.',
  intro: [
    {
      ko: '에듀포커스는 AI 기반 취약점 분석 기술로 학습자 개인의 약점을 정밀하게 파악하고, 최단 경로로 목표 점수에 도달할 수 있도록 설계된 집중 학습 루틴을 제공합니다.',
      en: 'EDUFOCUS uses AI-powered weak-point analysis to precisely pinpoint each learner\'s gaps, delivering focused study routines engineered to reach target scores by the shortest path.',
    },
    {
      ko: 'IELTS, DELF, 컴퓨터활용능력검정, 정보처리기사, 한국사능력검정 등 주요 어학·자격증 시험과 교과목 과외를 통해 학습자의 합격을 함께 준비합니다.',
      en: 'From IELTS, DELF, Computer Applications, IT Engineer, and Korean History to core subject tutoring, we prepare every learner for success across major language and certification exams.',
    },
  ],
  offices: [
    {
      label: { ko: '본사', en: 'Headquarters' },
      address: { ko: '서울특별시 강남구 테헤란로 123 에듀포커스빌딩 5층', en: '5F, EduFocus Bldg, 123 Teheran-ro, Gangnam-gu, Seoul' },
      tel: '02-1234-5678', fax: '02-1234-5679',
    },
    {
      label: { ko: '학습센터', en: 'Learning Center' },
      address: { ko: '서울특별시 마포구 독막로 45 에듀포커스 러닝센터', en: 'EduFocus Learning Center, 45 Dongmak-ro, Mapo-gu, Seoul' },
      tel: '02-9876-5432', fax: '02-9876-5433',
    },
  ],
  familySites: [
    { name: { ko: 'AI 학습앱 다운로드 (iOS)', en: 'Download AI App (iOS)' }, url: 'https://apps.apple.com' },
    { name: { ko: 'AI 학습앱 다운로드 (Android)', en: 'Download AI App (Android)' }, url: 'https://play.google.com' },
    { name: { ko: '에듀포커스 유튜브 채널', en: 'EDUFOCUS YouTube Channel' }, url: 'https://youtube.com' },
  ],
  footerLinks: [
    { label: { ko: '이용약관', en: 'Terms of Service' }, to: '/terms' },
    { label: { ko: '개인정보처리방침', en: 'Privacy Policy' }, to: '/privacy', strong: true },
    { label: { ko: '고객센터', en: 'Support Center' }, to: '/support' },
  ],
}
...
export const videoTopics = [
  {
    ...
    to: '/videos/ielts',
    videos: [
      { id: 'PLACEHOLDER_IELTS_01', title: { ko: 'IELTS Listening 고득점 전략 A', en: 'IELTS Listening: High-Score Strategies A' } },
      { id: 'PLACEHOLDER_IELTS_02', title: { ko: 'IELTS Reading 시간 관리 비법', en: 'IELTS Reading: Time-Management Tactics' } },
      { id: 'PLACEHOLDER_IELTS_03', title: { ko: 'IELTS Writing Task 2 고득점 루틴', en: 'IELTS Writing Task 2: High-Score Routine' } },
      { id: 'PLACEHOLDER_IELTS_04', title: { ko: 'IELTS Speaking Band 7+ 달성법', en: 'IELTS Speaking: How to Reach Band 7+' } },
      { id: 'PLACEHOLDER_IELTS_05', title: { ko: 'IELTS 취약 유형 집중 공략 (Listening)', en: 'IELTS Weak-Type Focus: Listening' } },
      { id: 'PLACEHOLDER_IELTS_06', title: { ko: 'IELTS Academic vs General 차이점 총정리', en: 'IELTS Academic vs General: Full Breakdown' } },
      { id: 'PLACEHOLDER_IELTS_07', title: { ko: 'IELTS Writing Task 1 그래프 묘사 완성', en: 'IELTS Writing Task 1: Mastering Graph Description' } },
      { id: 'PLACEHOLDER_IELTS_08', title: { ko: 'IELTS Reading True/False/NG 공략법', en: 'IELTS Reading: Cracking True/False/Not Given' } },
      { id: 'PLACEHOLDER_IELTS_09', title: { ko: 'IELTS 단기 점수 향상 집중 루틴', en: 'IELTS Rapid Score-Boost Routine' } },
      { id: 'PLACEHOLDER_IELTS_10', title: { ko: 'IELTS Speaking 실전 모의 테스트', en: 'IELTS Speaking: Full Mock Test' } },
      { id: 'PLACEHOLDER_IELTS_11', title: { ko: 'IELTS 취약점 분석 — AI 앱 활용법', en: 'IELTS Weak-Point Analysis with the AI App' } },
      { id: 'PLACEHOLDER_IELTS_12', title: { ko: 'IELTS 최신 기출 경향 분석 2026', en: 'IELTS 2026 Latest Exam-Trend Analysis' } },
    ],
  },
  {
    key: 'delf',
    ...
    to: '/videos/delf',
    videos: [
      { id: 'PLACEHOLDER_DELF_01', title: { ko: 'DELF A2 Production orale 합격 전략', en: 'DELF A2 Production Orale: Pass Strategy' } },
      { id: 'PLACEHOLDER_DELF_02', title: { ko: 'DELF B1 Compréhension écrite 완전 정복', en: 'DELF B1 Compréhension Écrite: Complete Mastery' } },
      { id: 'PLACEHOLDER_DELF_03', title: { ko: 'DELF B2 Production écrite 고득점 루틴', en: 'DELF B2 Production Écrite: High-Score Routine' } },
      { id: 'PLACEHOLDER_DELF_04', title: { ko: 'DELF C1 취약 영역 집중 공략법', en: 'DELF C1: Targeting Your Weak Areas' } },
      { id: 'PLACEHOLDER_DELF_05', title: { ko: 'DELF 프랑스어 어휘 집중 암기법', en: 'DELF French Vocabulary: Intensive Memorization' } },
      { id: 'PLACEHOLDER_DELF_06', title: { ko: 'DELF 시험 구성과 채점 기준 총정리', en: 'DELF Exam Format & Scoring Criteria Explained' } },
      { id: 'PLACEHOLDER_DELF_07', title: { ko: 'DELF A1 기초 회화 집중 훈련', en: 'DELF A1: Foundational Conversation Drills' } },
      { id: 'PLACEHOLDER_DELF_08', title: { ko: 'DELF B1 듣기 취약 유형 공략', en: 'DELF B1 Listening: Tackling Weak Types' } },
      { id: 'PLACEHOLDER_DELF_09', title: { ko: 'DELF B2 구술 시험 실전 연습', en: 'DELF B2 Oral Exam: Practical Practice' } },
      { id: 'PLACEHOLDER_DELF_10', title: { ko: 'DELF C2 최고 난이도 대비 전략', en: 'DELF C2: Strategies for the Highest Level' } },
      { id: 'PLACEHOLDER_DELF_11', title: { ko: 'DELF 취약점 AI 분석 활용 사례', en: 'DELF Weak-Point AI Analysis: Case Studies' } },
      { id: 'PLACEHOLDER_DELF_12', title: { ko: 'DELF 2026 출제 경향 분석', en: 'DELF 2026 Exam-Trend Analysis' } },
    ],
  },
  {
    key: 'computer',
    label: { ko: '컴퓨터활용능력', en: 'Computer Applications' },
    to: '/videos/computer',
    videos: [
      { id: 'PLACEHOLDER_COMP_01', title: { ko: '컴활 1급 엑셀 함수 집중 정리 A', en: 'CompA L1 Excel Functions: Deep Dive A' } },
      { id: 'PLACEHOLDER_COMP_02', title: { ko: '컴활 1급 엑셀 매크로·VBA 핵심', en: 'CompA L1 Excel Macros & VBA Essentials' } },
      { id: 'PLACEHOLDER_COMP_03', title: { ko: '컴활 1급 액세스 DB 설계 완성', en: 'CompA L1 Access DB Design Mastery' } },
      { id: 'PLACEHOLDER_COMP_04', title: { ko: '컴활 2급 스프레드시트 집중 특강', en: 'CompA L2 Spreadsheet Intensive' } },
      { id: 'PLACEHOLDER_COMP_05', title: { ko: '컴활 필기 기출 취약 유형 분석', en: 'CompA Written Exam: Weak-Type Analysis' } },
      { id: 'PLACEHOLDER_COMP_06', title: { ko: '컴활 실기 시험 시간 관리 전략', en: 'CompA Practical Exam: Time-Management Strategy' } },
      { id: 'PLACEHOLDER_COMP_07', title: { ko: '컴활 1급 함수 집중 정리 B (통계·텍스트)', en: 'CompA L1 Functions Deep Dive B (Statistical & Text)' } },
      { id: 'PLACEHOLDER_COMP_08', title: { ko: '컴활 1급 차트 작성 완전 정복', en: 'CompA L1 Charts: Complete Mastery' } },
      { id: 'PLACEHOLDER_COMP_09', title: { ko: '컴활 2급 실기 최빈 오류 정리', en: 'CompA L2 Practical: Most Common Errors' } },
      { id: 'PLACEHOLDER_COMP_10', title: { ko: '컴활 취약점 AI 분석 활용법', en: 'CompA Weak-Point AI Analysis Guide' } },
      { id: 'PLACEHOLDER_COMP_11', title: { ko: '컴활 1급 쿼리 작성 집중 훈련', en: 'CompA L1 Query Writing: Intensive Drills' } },
      { id: 'PLACEHOLDER_COMP_12', title: { ko: '컴활 최신 기출 복원 풀이 2026', en: 'CompA 2026 Reconstructed Exam Walkthrough' } },
    ],
  },
  {
    key: 'it',
    label: { ko: '정보처리기사', en: 'IT Engineer' },
    to: '/videos/it',
    videos: [
      { id: 'PLACEHOLDER_IT_01', title: { ko: '정처기 필기 1과목 소프트웨어 설계', en: 'IT Engineer Written 1: Software Design' } },
      { id: 'PLACEHOLDER_IT_02', title: { ko: '정처기 필기 2과목 소프트웨어 개발', en: 'IT Engineer Written 2: Software Development' } },
      { id: 'PLACEHOLDER_IT_03', title: { ko: '정처기 필기 3과목 데이터베이스 구축', en: 'IT Engineer Written 3: Database Construction' } },
      { id: 'PLACEHOLDER_IT_04', title: { ko: '정처기 필기 4과목 프로그래밍 언어', en: 'IT Engineer Written 4: Programming Languages' } },
      { id: 'PLACEHOLDER_IT_05', title: { ko: '정처기 필기 5과목 정보시스템 구축 관리', en: 'IT Engineer Written 5: Information-System Management' } },
      { id: 'PLACEHOLDER_IT_06', title: { ko: '정처기 실기 작업형 집중 대비', en: 'IT Engineer Practical: Task-Type Intensive Prep' } },
      { id: 'PLACEHOLDER_IT_07', title: { ko: '정처기 취약 알고리즘 집중 정리', en: 'IT Engineer: Weak-Algorithm Deep Dive' } },
      { id: 'PLACEHOLDER_IT_08', title: { ko: '정처기 SQL 핵심 쿼리 완성', en: 'IT Engineer SQL: Core Queries Mastery' } },
      { id: 'PLACEHOLDER_IT_09', title: { ko: '정처기 필기 단기 완성 전략', en: 'IT Engineer Written: Fast-Track Strategy' } },
      { id: 'PLACEHOLDER_IT_10', title: { ko: '정처기 취약점 AI 분석 활용 사례', en: 'IT Engineer Weak-Point AI Analysis: Case Studies' } },
      { id: 'PLACEHOLDER_IT_11', title: { ko: '정처기 실기 서술형 답안 작성법', en: 'IT Engineer Practical: Writing Descriptive Answers' } },
      { id: 'PLACEHOLDER_IT_12', title: { ko: '정처기 최신 기출 경향 분석 2026', en: 'IT Engineer 2026 Latest Exam-Trend Analysis' } },
    ],
  },
  {
    key: 'history',
    label: { ko: '한국사능력검정', en: 'Korean History' },
    to: '/videos/history',
    videos: [
      { id: 'PLACEHOLDER_HIST_01', title: { ko: '한능검 심화 선사~삼국 핵심 정리', en: 'K-History Advanced: Prehistory–Three Kingdoms Essentials' } },
      { id: 'PLACEHOLDER_HIST_02', title: { ko: '한능검 심화 고려~조선 취약 포인트', en: 'K-History Advanced: Goryeo–Joseon Weak Points' } },
      { id: 'PLACEHOLDER_HIST_03', title: { ko: '한능검 심화 근현대사 집중 공략', en: 'K-History Advanced: Modern & Contemporary Focus' } },
      { id: 'PLACEHOLDER_HIST_04', title: { ko: '한능검 기본 3·4급 단기 합격 전략', en: 'K-History Standard L3·4: Fast-Pass Strategy' } },
      { id: 'PLACEHOLDER_HIST_05', title: { ko: '한능검 사료 분석 유형 완전 정복', en: 'K-History: Mastering Source-Analysis Questions' } },
      { id: 'PLACEHOLDER_HIST_06', title: { ko: '한능검 취약 단원 AI 분석 활용법', en: 'K-History Weak-Unit AI Analysis Guide' } },
      { id: 'PLACEHOLDER_HIST_07', title: { ko: '한능검 심화 문화사 핵심 정리', en: 'K-History Advanced: Cultural-History Essentials' } },
      { id: 'PLACEHOLDER_HIST_08', title: { ko: '한능검 연표 암기 핵심 테크닉', en: 'K-History: Timeline Memorization Techniques' } },
      { id: 'PLACEHOLDER_HIST_09', title: { ko: '한능검 지도·유물 유형 집중 공략', en: 'K-History: Map & Artifact Question Focus' } },
      { id: 'PLACEHOLDER_HIST_10', title: { ko: '한능검 최빈 오답 TOP 20 분석', en: 'K-History: Top 20 Most-Missed Questions' } },
      { id: 'PLACEHOLDER_HIST_11', title: { ko: '한능검 최신 기출 복원 풀이 2026', en: 'K-History 2026 Reconstructed Exam Walkthrough' } },
      { id: 'PLACEHOLDER_HIST_12', title: { ko: '한능검 심화 50일 완성 루틴 공개', en: 'K-History Advanced: The 50-Day Mastery Routine' } },
    ],
  },
  {
    key: 'ai-app',
    label: { ko: 'AI앱 활용', en: 'AI App Guide' },
    to: '/videos/ai-app',
    videos: [
      { id: 'PLACEHOLDER_AI_01', title: { ko: 'AI 취약점 분석 앱 기본 사용법', en: 'AI Weak-Point App: Getting Started' } },
      { id: 'PLACEHOLDER_AI_02', title: { ko: 'AI 학습 루틴 설계 — IELTS 편', en: 'AI Study-Routine Builder: IELTS Edition' } },
      { id: 'PLACEHOLDER_AI_03', title: { ko: 'AI 학습 루틴 설계 — 자격증 편', en: 'AI Study-Routine Builder: Certifications Edition' } },
      { id: 'PLACEHOLDER_AI_04', title: { ko: 'AI 취약점 리포트 해석하는 법', en: 'How to Read Your AI Weak-Point Report' } },
      { id: 'PLACEHOLDER_AI_05', title: { ko: 'AI 맞춤 문제 생성 기능 활용법', en: 'Using AI-Generated Custom Questions' } },
      { id: 'PLACEHOLDER_AI_06', title: { ko: 'AI 앱으로 자기주도학습 루틴 만들기', en: 'Building a Self-Study Routine with the AI App' } },
      { id: 'PLACEHOLDER_AI_07', title: { ko: 'AI 오답 노트 자동 생성 기능', en: 'Auto-Generated Mistake Notes with AI' } },
      { id: 'PLACEHOLDER_AI_08', title: { ko: 'AI 앱 주간 학습 목표 설정법', en: 'Setting Weekly Goals in the AI App' } },
      { id: 'PLACEHOLDER_AI_09', title: { ko: 'AI 취약점 집중 문제 추천 알고리즘', en: 'Inside the AI Weak-Point Recommendation Engine' } },
      { id: 'PLACEHOLDER_AI_10', title: { ko: 'AI 앱 활용 30일 합격 챌린지', en: 'The 30-Day Pass Challenge with the AI App' } },
      { id: 'PLACEHOLDER_AI_11', title: { ko: 'AI 앱 v2.0 신기능 완전 소개', en: 'AI App v2.0: Full New-Feature Tour' } },
      { id: 'PLACEHOLDER_AI_12', title: { ko: 'AI 기반 자기주도학습 성공 사례 모음', en: 'AI Self-Study Success Stories' } },
    ],
  },
]
